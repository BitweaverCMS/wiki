...
$gBitInstaller->registerPreferences( WIKI_PKG_NAME, array(
	...
	array( WIKI_PKG_NAME, 'autolinks','y'),
	array( WIKI_PKG_NAME, 'backlinks','y'),
	...
	array( WIKI_PKG_NAME, 'allow_dup_wiki_page_names','y'),
	array( WIKI_PKG_NAME, 'wiki_list_pages','y'),
	array( WIKI_PKG_NAME, 'page_title','y'),
	//array( WIKI_PKG_NAME, 'wiki_ranking','n'),
	array( WIKI_PKG_NAME, 'sandbox','y'),

...
<div class="admin wiki">
	<div class="header">
		<h1>Permissions for <a href="{$gContent->mInfo.display_url}">{$gContent->mInfo.title|escape}</a></h1>
	</div>
	...
	<div class="body">
		{form legend="Notify via email when updated"}
			...
			<div class="form-group submit">
				<input type="submit" class="btn btn-default" name="addemail" value="Add email address" />
			</div>
		{/form}

		{if count( $emails ) gt 0 }
			<h2>Existing requests for email notification</h2>
			<ul>

...
{tr}You can view the page by following this link:
    {$mail_machine}/{$gBitLoc.WIKI_PKG_URL}index.php?page={$mail_page|escape:"url"}{/tr}


{tr}You can edit the page by following this link:
    {$mail_machine}/{$gBitLoc.WIKI_PKG_URL}edit.php?page={$mail_page|escape:"url"}{/tr}


{tr}You can view a diff back to the previous version by following
this link:
    {$mail_machine}/{$gBitLoc.WIKI_PKG_URL}page_history.php?page={$mail_page|escape:"url"}&amp;diff2={$mail_last_version}{/tr}

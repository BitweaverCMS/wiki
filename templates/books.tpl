...
{if count($showstructs) ne 0}
	<div class="form-group">
		...
		{forminput}
			<a id="show_strct" style="display:block;" href="javascript:show('showstructs');show('hide_strct');hide('show_strct')">show books</a>
			<a id="hide_strct" style="display:none;" href="javascript:hide('showstructs');show('show_strct');hide('hide_strct')">hide books</a>

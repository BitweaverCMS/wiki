...
{jstabs}
			...
			<div class="form-group">
				...
				{forminput}
					<select class="form-control" name="wiki_section_edit" id="wiki_section_edit">
						<option value="0" {if $gBitSystem->getConfig('wiki_section_edit') eq 0}selected="selected"{/if}>Disabled</option>
			...
			<div class="form-group">
				...
				{forminput}
					<select class="form-control" name="wiki_tables" id="wiki_tables">
						<option value="old" {if $gBitSystem->getConfig('wiki_tables') eq 'old'}selected="selected"{/if}>or for rows</option>
						<option value="new" {if $gBitSystem->getConfig('wiki_tables') eq 'new'}selected="selected"{/if}>\n for rows</option>
					</select>
					{formhelp note="Either use or to start a new row in a table, or start a new line (recommended)."}
				{/forminput}
			</div>

			<div class="form-group submit">
				<input type="submit" class="btn btn-default" name="wikifeatures" value="Change preferences" />
			</div>
		{/form}
	{/jstab}
	...
	{jstab title="Wiki Books"}
		{form legend="Wiki Book Settings"}
			...
			{/foreach}
			<div class="form-group submit">
				<input type="submit" class="btn btn-default" name="wikibooks" value="Change preferences" />
			</div>
		{/form}
	{/jstab}
	...
	{jstab title="In and Output"}
		{form legend="Wiki Input and Output Settings"}
			...
			{/foreach}
			<div class="form-group submit">
				<input type="submit" class="btn btn-default" name="wikiinout" value="Change preferences" />
			</div>
		{/form}
	{/jstab}
	...
	{jstab title="List Settings"}
		{form legend="List Settings"}
			...
			<div class="form-group submit">
				<input type="submit" class="btn btn-default" name="wikilistconf" value="Change preferences" />
			</div>
		{/form}
	{/jstab}
	...
	{jstab title="Wiki Settings"}
		{form}
			{legend legend="Wiki Home Page"}
				...
				<div class="form-group">
					{forminput label="checkbox"}
						{html_checkboxes name="wiki_disable_auto_home" values="y" checked=$gBitSystem->getConfig('wiki_disable_auto_home') labels=false id="wiki_disabled_auto_home"} Disable Wiki Home Page
				...
				<div class="form-group submit">
					<input type="submit" class="btn btn-default" name="setwikihome" value="Change preferences" />
				</div>
			{/legend}
			...
			{legend legend="Wiki Link Format"}
				<div class="form-group">
					...
					{forminput}
						<select class="form-control" name="wiki_page_regex" id="wiki_page_regex">
							<option value="strict"   {if $gBitSystem->getConfig('wiki_page_regex') eq 'strict'}selected="selected"{/if}>English</option>
							<option value="full"     {if $gBitSystem->getConfig('wiki_page_regex') eq 'full'}selected="selected"{/if}>Latin</option>
							<option value="complete" {if $gBitSystem->getConfig('wiki_page_regex') eq 'complete'}selected="selected"{/if}>Complete</option>
						</select>
				...
				<div class="form-group submit">
					<input type="submit" class="btn btn-default" name="setwikiregex" value="Change preferences" />
				</div>
			{/legend}
			...
			{legend legend="Copyright Management"}
				<div class="form-group">
					{forminput label="checkbox"}
						{html_checkboxes name="wiki_copyrights" values="y" checked=$gBitSystem->getConfig('wiki_copyrights') labels=false id="wiki_copyrights"} Enable Feature
					{/forminput}
				</div>
				...
				<div class="form-group submit">
					<input type="submit" class="btn btn-default" name="wikisetcopyright" value="Change preferences" />
				</div>
			{/legend}
			...
			{legend legend="Wiki Watch"}
				...
				<div class="form-group submit">
					<input type="submit" class="btn btn-default" name="wikiwatch" value="Change preferences" />
				</div>
			{/legend}
		{/form}
	{/jstab}

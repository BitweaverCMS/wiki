...
<ul class="{$packageMenuClass}">
	...
	{/if}
	{if $gBitSystem->isFeatureActive( 'wiki_books' ) and $gBitUser->hasPermission( 'p_wiki_create_book' )}
	...
	<li><a title="Wiki Update RSS Feed" href="{$smarty.const.RSS_PKG_URL}index.php?pkg=wiki">{booticon iname="icon-rss" ipackage=rss iexplain="Changes Feed" ilocation=menu}</a></li>
	{/if}
</ul>
{/strip}

...
<ul>
	...
	{/if}
	{if $gBitSystem->isFeatureActive( 'wiki_list_pages' ) and $gBitUser->hasPermission( 'bit_p_view' )}
	...
	{/if}
	{if $gBitUser->hasPermission( 'bit_p_view' ) and $gBitSystem->isFeatureActive( 'wiki_books' )}
	...
	{/if}
	{if $gBitSystem->isFeatureActive( 'wiki_books' ) && $gBitUser->hasPermission( 'bit_p_edit_books' )}
	...
	{/if}
	{if $gBitSystem->isFeatureActive( 'wiki_multiprint' ) and $gBitUser->hasPermission( 'bit_p_view' )}
	...
	{/if}
	{if $gBitSystem->isFeatureActive( 'wiki_rankings' ) and $gBitUser->hasPermission( 'bit_p_view' )}
	...
	{/if}
	{if $gBitSystem->isFeatureActive( 'wiki_dump' ) and $gBitUser->hasPermission( 'bit_p_view' )}
	...
	{/if}
	{if $gBitSystem->isFeatureActive( 'sandbox' ) and $gBitUser->hasPermission( 'bit_p_view' )}

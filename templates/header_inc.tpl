{* $Header: /cvsroot/bitweaver/_bit_wiki/templates/header_inc.tpl,v 1.4 2006/04/11 13:10:33 squareing Exp $ *}
{strip}
{if $gBitSystem->isPackageActive( 'rss' ) and $smarty.const.ACTIVE_PACKAGE eq 'wiki' and $gBitUser->hasPermission( 'p_wiki_view_page' )}
